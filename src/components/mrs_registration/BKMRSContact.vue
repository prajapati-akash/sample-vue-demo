...
export default{
    ...
    created() {
        ...
        // this.loadTitleList("GEN_2010_1004", "IsDefaultList");
    },
    methods :{
        ...
        EditContactList(id) {
            if(typeof this.Contactlist[id] != 'undefined') {
                ...
                this.EditContactListData.contact_email = this.Contactlist[id].contact_email
                this.EditContactListData.contact_name = this.Contactlist[id].contact_name
                this.EditContactListData.contact_person_mobile = this.Contactlist[id].contact_person_mobile
                this.EditContactListData.contact_title = this.Contactlist[id].contact_title
                this.EditContactListData.whatsapp_number_country = this.Contactlist[id].whatsapp_number_country
                this.EditContactListData.whatsapp_number = this.Contactlist[id].whatsapp_number
                this.EditContactListData.gender = this.Contactlist[id].gender
                this.EditContactListData.is_default = this.Contactlist[id].is_default
                this.EditContactListData.mobile_country = this.Contactlist[id].mobile_country
                this.EditContactListData.designation = this.Contactlist[id].designation
