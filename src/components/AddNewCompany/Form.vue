<template>
    <div class="bg-white dark:bg-gray-800">
        <div class="mx-auto max-w-7xl">
            ...
            {{ this.formValue.general_info.company_name }}
                        ...
                        <div class="px-4 py-5 flex-auto">
                            <div class="tab-content tab-space">
                                ...
                                <div v-bind:class="{ 'hidden': openTab !== 1, 'block': openTab === 1 }">
                                    <Form @submit="generalInfoNext" :validation-schema="schema"
                                        @invalid-submit="oninvalidGeneralInfo">
                                        <div class="grid">
                                                ...
                                                <div class="sm:col-span-2">
                                                    ...
                                                    <div class="mt-2">
                                                        <Field type="text" name="company_name" id="company_name"
                                                            ...
                                                            :value="formValue.general_info.company_name"
...
export default {
    ...
    watch : {
        'formValue.general_info.company_name': function ( newValue, oldValue){
            console.log('new value : ' +  newValue)
            console.log('old value : ' +  oldValue)
            console.log(newValue == '')

            if(newValue == '') {
                this.formValue.general_info.company_name = oldValue
            }
        },
    }
}
