    ...
    <div class="mx-auto max-w-7xl">
      <Form @submit="submitForm">
        <div class="space-y-12">
          ...
          <div class="border-b border-gray-900/10 pb-12">
            <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-8">
              ...
              <div class="sm:col-span-4">
                <label for="selectVendorName"
                  class="text-left block text-lg font-medium leading-6 text-gray-900">INTERESTED TO PROVIDE SUPPLIES :
                </label>
                <div class="mt-2">
                  <Field as="select" v-model="data.selectVendorName" id="selectVendorName" name="selectVendorName"
                    autocomplete="optionVendorName"
                    class="block w-full rounded-lg border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                    :rules="validateSelectRequiredField">
                    <option value="">Select a vendor</option>
                    <template v-if="vendorRecords">
                      <option
                        v-for="vendorRecord in vendorRecords"
                        :value="vendorRecord.company_name"
            ...
            <!-- BUSINESS PROFILE Section heading -->
              ...
              <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-8">
                ...
                <!-- Bussiness name -->
                <div class="sm:col-span-4">
                  <label for="bussiness_name" class="text-left block text-lg font-medium leading-6 text-gray-900">Bussiness
                    name :</label>
                  <div class="mt-2">
                ...
                <div class="sm:col-span-4 ">
                  <label for="registered_bussiness_name"
                    class="text-left block text-lg font-medium leading-6 text-gray-900">Registered Business Name</label>
                  <div class="mt-2">
                ...
                <div class="sm:col-span-2">
                  <label for="currency" class="text-left text-lg block font-medium leading-6 text-gray-900">Currency :
                  </label>
                  <div class="mt-2">
                    <Field as="select" v-model="data.currency" id="currency" name="currency" autocomplete="currency"
                      ...
                      <template v-if="allCurrencyList">
                        <option
                          v-for="currency in allCurrencyList" :value="currency.sc_isocode+ '( ' + currency.sc_symbol + ')'"
                ...
                <div class="sm:col-span-2">
                  <label for="date_of_incorporation"
                    class="text-left block text-lg font-medium leading-6 text-gray-900">date of incorporation : </label>
                  <div class="mt-2">
                ...
                <!-- Form of Business -->
                <div class="sm:col-span-4">
                  <label for="form_of_bussiness" class="text-left block text-lg font-medium leading-6 text-gray-900">Form of
                    Business</label>
                  <div class="mt-2">
                    <Field as="select" v-model="data.form_of_bussiness" id="form_of_bussiness" name="form_of_bussiness"
                      ...
                      <template v-if="formOfBussinessList.length > 0">
                        <option v-for="formOfBussiness in formOfBussinessList" :value="formOfBussiness.child_enum_slug" :key="formOfBussiness.id">
                ...
                <div class="sm:col-span-4">
                  <label for="currency" class="text-left text-lg block font-medium leading-6 text-gray-900">Type of
                    bussiness : </label>
                  <div class="mt-2">
                    <Field as="select" v-model="data.type_of_bussiness" id="type_of_bussiness" name="type_of_bussiness"
                      ...
                      <template v-if="typeOfBussinessList.length > 0">
                        <option v-for="typeOfBussiness in typeOfBussinessList" :value="typeOfBussiness.child_enum_slug" :key="typeOfBussiness.id">
            ...
            <!-- COMMUNICATION INFORMATION Section heading -->
              ...
              <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-8">
                ...
                <!-- Email address -->
                <div class="sm:col-span-2">
                  <label for="email" class="text-left block text-lg font-medium leading-6 text-gray-900">
                    Email :
                  </label>
                  <div class="mt-2">
                ...
                <!-- Website Url -->
                <div class="sm:col-span-2">
                  <label for="website_url" class="text-left block text-lg font-medium leading-6 text-gray-900">
                    Website URL :
                  </label>
                  <div class="mt-2">
                    <Field
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="flex">
                    <div class="w-24 mt-2">
                        <Field as="select" v-model="data.mobile_country" id="mobile_country" name="mobile_country" autocomplete="mobile_country"
                    ...
                    <div class="w-5 mt-2 pl-2">
                      <Field v-model="data.mobile_number" type="number" name="mobile_number"
                        id="mobile_number" autocomplete="mobile_number"
                ...
                <div class="sm:col-span-2">
                  ...
                  <div class="flex">
                    <div class="w-24 mt-2">
                        <Field as="select" v-model="data.fax_country" id="fax_country" name="fax_country" autocomplete="fax_country"
                          class="block w-24 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                          :rules="validateSelectRequiredField">
                          <option value="">Country</option>
                          <option v-for="(type, index) in countryList" :value="type.mc_country_code" :key="index">
                    ...
                    <div class="w-5 mt-2 pl-2">
                      <Field v-model="data.fax_number" type="number" name="fax_number"
                        id="fax_number" autocomplete="fax_number"
                        class="block w-52 rounded-md border-0 py-1.5 text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-indigo-600 sm:text-sm sm:leading-6"
                        :rules="validateMobileField" />
                        <p class="text-left text-red-500 w-52">
          ...
          <MRSAddress 
            componentTitle="CORRESPONDING ADDRESS"
            :countryList="countryList"
            :isDefaultList="IsDefaultList"
          ...
          <MRSTaxInformation
            componentTitle="TAX INFORMATION"
            @complete-tax-information="addTaxInformation"
          />
          <!-- end Tax information  -->

          <!-- start bank information  -->
          <MRSBankInformation
            componentTitle="BANKING INFORMATION"
            :currencyList="allCurrencyList"
            :countryList="countryList"
            :isDefaultList="IsDefaultList"
            @complete-bank-information="addBankInformation"
          />
